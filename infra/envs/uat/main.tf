...
module "eks_app" {
  ...
  # ALB traffic-weighted canary for SPA only: one extra nginx pod + 10% to canary Service (API paths unchanged).
  enable_alb_weighted_canary_for_web = true
  alb_web_canary_traffic_percent     = 10
  web_canary_replicas                = 1
